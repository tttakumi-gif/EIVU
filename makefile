CXXFLAGS = -std=c++17 -pthread -march=native -mtune=native -Wall -Wextra -ffast-math -mfpmath=both -O3 #-fopt-info-vec-optimized -fopt-info-vec-missed  -fomit-frame-pointer 
