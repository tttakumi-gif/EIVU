CXXFLAGS = -std=c++11 -pthread -march=native -mtune=native -O3 -Wall -Wextra -ffast-math -mfpmath=both #-fopt-info-vec-optimized -fopt-info-vec-missed  -fomit-frame-pointer 
