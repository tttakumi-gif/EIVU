CXXFLAGS = -std=c++11 -pthread -march=native -mtune=native -mfpmath=both -ffast-math -fomit-frame-pointer -O3 -Wall -Wextra #-fopt-info-vec-optimized -fopt-info-vec-missed 
