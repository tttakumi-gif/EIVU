...
opt_perf="-M L1MPKI,L2MPKI,L3MPKI -e l2_lines_out.useless_hwpf,offcore_requests_outstanding.cycles_with_demand_rfo,LLC-loads,LLC-stores,l1d_pend_miss.fb_full" 
