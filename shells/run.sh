...
opt_perf="-e cache-misses,L1-dcache-load-misses,L1-dcache-loads,L1-dcache-stores,l2_rqsts.references,l2_rqsts.miss,LLC-load-misses,LLC-store-misses,cycle_activity.stalls_l3_miss"
