...
opt_perf="-e L1-dcache-load-misses,L1-dcache-loads,L1-dcache-stores,l2_rqsts.references,l2_rqsts.miss,LLC-load-misses,LLC-loads,LLC-store-misses,LLC-stores"
